            ...
            <Toolbar>
                <div className="flex items-center gap-1">
                    <ToolbarTextLink
                        ...
                        tooltip={t("enchantment.simulation.toolbar.back")}
                        labelText={t("enchantment.simulation.toolbar.back")}
                        to="/editor/enchantment/overview"
                    />
                    <ToolbarTextButton
                        icon="/icons/tools/overview/help.svg"
                        tooltip={t("enchantment.simulation.toolbar.help")}
                        onClick={() => dialogRef.current?.open()}
                        labelText={t("enchantment.simulation.toolbar.help")}
                    />
                </div>
