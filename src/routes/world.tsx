            ...
            <main className="relative z-10 flex-1 flex flex-col min-w-0">
                <header className="relative shrink-0 h-40 w-full flex flex-col justify-end px-12 pb-8">
                    <div className="relative flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <button type="button" className="px-6 py-3 rounded-xl bg-white text-black font-bold hover:bg-zinc-200 transition-colors shadow-lg shadow-white/5">
                                Play Instance
                            </button>
                            <button type="button" className="p-3 rounded-xl bg-zinc-900/50 border border-zinc-800 backdrop-blur-md text-zinc-400 hover:text-white transition-all">
