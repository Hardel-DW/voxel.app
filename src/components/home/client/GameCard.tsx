...
import { getVersionBackground } from "@/lib/utils/instance";
    ...
    return (
        <Link
            ...
            <div className="overflow-hidden aspect-video bg-zinc-800/50">
                <img src={imageSrc} alt={data.name} className="size-full object-cover transition-transform duration-300 group-hover:scale-105" />
            </div>
            <div className="p-2.5">
